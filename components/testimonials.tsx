			...
			<div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
				<div className="max-w-xl sm:text-center md:mx-auto">
					...
					<p className="mt-3 text-gray-600 text-[18px]">
						...
						custom-built PCs that exceed expectations. But don’t just take
						our word for it - see what people have to say about their
						experience with us. From gaming enthusiasts to businesses
						seeking high-performance systems, people appreciate the
						attention to detail, performance, and value we provide. Explore
						their stories and discover why so many trust us to build their
						perfect PC.
					</p>
				</div>
