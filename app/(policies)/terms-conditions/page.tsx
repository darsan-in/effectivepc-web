...
export default function TermsConditions() {
	return (
		<main className="policy">
			...
			<p>Last updated: 2024-10-04</p>
			<p className="sub-head">
				1. <b>Introduction</b>
			</p>
			<p>
				Welcome to <b>Effective PC</b> (“Company”, “we”, “our”, “us”)!
			</p>
			<p>
				These Terms of Service (“Terms”, “Terms of Service”) govern your
				use of our website located at <b>effectivepc.in</b> (together or
				individually “Service”) operated by <b>Effective PC</b>.
			</p>
			<p>
			...
			<p>
				...
				<b>help@effectivepc.in</b> so we can try to find a solution. These
			...
			<p>
				...
				emailing at help@effectivepc.in.
			</p>
			<p className="sub-head">
				3. <b>Purchases</b>
			</p>
			...
			<p>
				...
				Effective PC or used with permission. You may not distribute,
			...
			<p>
				...
				exclusive property of Effective PC and its licensors. Service is
				...
				product or service without the prior written consent of Effective
				PC.
			</p>
			<p className="sub-head">
			...
			<p>
				...
				email to help@effectivepc.in, with the subject line: “Copyright
			...
			<p>
				You may provide us either directly at help@effectivepc.in or via
			...
			<p>
				...
				that are not owned or controlled by Effective PC.
			</p>
			<p>
				Effective PC has no control over, and assumes no responsibility for
			...
			<p>
				...
				ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THEIR
			...
			<p>
				...
				by email: <b>help@effectivepc.in</b>.
			</p>
		</main>
	);
}
