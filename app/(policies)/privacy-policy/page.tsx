...
export default function PrivacyPolicy() {
	return (
		<main className="policy">
			...
			<p>Effective date: 2024-10-04</p>
			<p className="sub-head">
				1. <b>Introduction</b>
			</p>
			<p>
				Welcome to <b> Effective PC</b>.
			</p>
			<p>
				<b>Effective PC</b> (“us”, “we”, or “our”) operates{" "}
				<b>effectivepc.in</b> (hereinafter referred to as <b>“Service”</b>
				).
			</p>
			<p>
				Our Privacy Policy governs your visit to <b>effectivepc.in</b>, and
			...
			<p>
				<b>SERVICE</b> means the effectivepc.in website operated by
				Effective PC.
			</p>
			<p>
			...
			<p>Effective PC uses the collected data for various purposes:</p>
			...
			<p>
				Effective PC will take all the steps reasonably necessary to ensure
			...
			<p>
				...
				emailing us at <b>help@effectivepc.in</b>.
			</p>
			...
			<p>
				<b>
					...
					any service providers to do the same. In some cases, deletion may
					be accomplished through de-identification of the information. If
			...
			<p>
				...
				please send your request(s) by email: <b>help@effectivepc.in</b>.
			</p>
			<p>
			...
			<p>
				...
				us by email: <b>help@effectivepc.in</b>.
			</p>
		</main>
	);
}
