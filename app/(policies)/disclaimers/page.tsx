...
export default function Disclaimer() {
	return (
		<main className="policy">
			...
			<p>
				The information provided by <b>Effective PC</b> (“Company”, “we”,
				“our”, “us”) on <b>effectivepc.in</b> (the “Site”) is for general
			...
			<p className="sub-head">YOUR INDIVIDUAL RESULTS MAY VARY.</p>{" "}
			<p>
			...
			<p>
				...
				Effective PC is not responsible for any errors or omissions or for
			...
			<p>
				In no event will Effective PC, its related partnerships or
			...
			<p>
				...
				represent those of Effective PC or any of its staff or affiliates
			...
			<p>
				...
				effectivepc.in are the trademarks and logos of their respective
				owners. Any inclusion of such trademarks or logos does not imply or
				constitute any approval, endorsement or sponsorship of Effective PC
				by such owners.
			</p>
			<p className="sub-head">
				<b>CONTACT US</b>
